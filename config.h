...
#define FFMPEG_CONFIGURATION "--enable-libx264 --enable-libvorbis --enable-libvpx --enable-libopus --enable-libmp3lame --enable-gpl --enable-opengl --enable-filter=gltransition --extra-libs='-lGLEW -lglfw' --enable-openssl --enable-nonfree --enable-shared --disable-static --enable-pic --disable-doc"
