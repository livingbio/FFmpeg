...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-libx264 --enable-libvorbis --enable-libvpx --enable-libopus --enable-libmp3lame --enable-gpl --enable-opengl --enable-filter=gltransition --extra-libs='-lGLEW -lglfw' --enable-openssl --enable-nonfree --enable-shared --disable-static --enable-pic --disable-doc
prefix=/usr/local
...
CFLAGS=   -std=c11 -fomit-frame-pointer -fPIC -pthread  -I/usr/include/opus -I/usr/include/opus             -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
...
avutil_FFLIBS=
EXTRALIBS-avdevice=-lm -lxcb -lxcb-shm -lxcb -lxcb-shape -lxcb -lxcb-xfixes -lxcb-render -lxcb-shape -lxcb -lGL
EXTRALIBS-avfilter=-pthread -lm
EXTRALIBS-swscale=-lm
EXTRALIBS-postproc=-lm
EXTRALIBS-avformat=-lm -lbz2 -lz -lssl -lcrypto
EXTRALIBS-avcodec=-lvpx -lm -lvpx -lm -lvpx -lm -lvpx -lm -pthread -lm -llzma -lz -lmp3lame -lm -lopus -lvorbis -lvorbisenc -lx264
